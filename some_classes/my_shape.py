...
class Shape(AbstractShape): # we choose to inherit from our ABC
    ...
    def __init__(self, num_sides, size, colour) -> None: # here is an annotation reminding us this method will return nothing
...
def main():
    ...
    try:
        # shape needs num_sides, size and colour
        s1 = Shape(3, 4.5, 'green') # this will invoke the __init__ method once
